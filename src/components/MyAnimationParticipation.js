...
function MyAnimationParticipation() {
  ...
  const pdfLink = `/myAnimation/${userId}?name=${encodeURIComponent(nom)}&firstName=${encodeURIComponent(prenom)}`;
...
export default MyAnimationParticipation;
