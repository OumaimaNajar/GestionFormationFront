...
function MyAttest() {
  ...
  const handleDownloadAll = async () => {
    try {
      ...
      // Utilisez un délai pour permettre le téléchargement avant d'imprimer
      setTimeout(() => {
        window.print();
      }, 1000);
  ...
  return (
    <AttestationContainer>
      <AttestationCard className="attestation-card">
        ...
        <CardTitle>Attestation de participation à des formations</CardTitle>
        <AttestationText>
        ...
        <FooterContainer>
          ...
          <FooterRight>
            Tunis, le {new Date().toLocaleDateString()}
            <br />
            <br />
            Signature
          </FooterRight>
